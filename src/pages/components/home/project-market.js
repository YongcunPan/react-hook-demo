...
import css from './project-market.module.less';


export const ProjectMarket =(props)=>{
                ...
                items.map((opt,index)=>
                    <div className={ css.item } key={ index }>
                        <div className={ css.itemInner }>
                            <div className={ css.titleimg } onClick={ ()=>toViewPage && toViewPage(opt) }>
                                <img src={ demoimg } alt=""/>
                            </div>
                            <div className={ css.descwrap }>
                                <div className={ css.title } onClick={ ()=>toViewPage && toViewPage(opt) }>{ opt.title }</div>
